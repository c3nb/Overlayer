	...
	public partial class FirebugConsole
	{
		...
		private static object __STUB__Log(ScriptEngine engine, object thisObj, object[] args)
		{
			...
			if (!(thisObj is FirebugConsole))
				throw new JavaScriptException(ErrorType.TypeError, "The method 'log' is not generic.");
			switch (args.Length)
			{
				case 0:
		...
		private static object __STUB__Debug(ScriptEngine engine, object thisObj, object[] args)
		{
			thisObj = TypeConverter.ToObject(engine, thisObj);
			if (!(thisObj is FirebugConsole))
				throw new JavaScriptException(ErrorType.TypeError, "The method 'debug' is not generic.");
			switch (args.Length)
			{
				case 0:
		...
		private static object __STUB__Info(ScriptEngine engine, object thisObj, object[] args)
		{
			thisObj = TypeConverter.ToObject(engine, thisObj);
			if (!(thisObj is FirebugConsole))
				throw new JavaScriptException(ErrorType.TypeError, "The method 'info' is not generic.");
			switch (args.Length)
			{
				case 0:
		...
		private static object __STUB__Warn(ScriptEngine engine, object thisObj, object[] args)
		{
			thisObj = TypeConverter.ToObject(engine, thisObj);
			if (!(thisObj is FirebugConsole))
				throw new JavaScriptException(ErrorType.TypeError, "The method 'warn' is not generic.");
			switch (args.Length)
			{
				case 0:
		...
		private static object __STUB__Error(ScriptEngine engine, object thisObj, object[] args)
		{
			thisObj = TypeConverter.ToObject(engine, thisObj);
			if (!(thisObj is FirebugConsole))
				throw new JavaScriptException(ErrorType.TypeError, "The method 'error' is not generic.");
			switch (args.Length)
			{
				case 0:
		...
		private static object __STUB__Assert(ScriptEngine engine, object thisObj, object[] args)
		{
			thisObj = TypeConverter.ToObject(engine, thisObj);
			if (!(thisObj is FirebugConsole))
				throw new JavaScriptException(ErrorType.TypeError, "The method 'assert' is not generic.");
			switch (args.Length)
			{
				case 0:
		...
		private static object __STUB__Group(ScriptEngine engine, object thisObj, object[] args)
		{
			thisObj = TypeConverter.ToObject(engine, thisObj);
			if (!(thisObj is FirebugConsole))
				throw new JavaScriptException(ErrorType.TypeError, "The method 'group' is not generic.");
			switch (args.Length)
			{
				case 0:
		...
		private static object __STUB__GroupCollapsed(ScriptEngine engine, object thisObj, object[] args)
		{
			thisObj = TypeConverter.ToObject(engine, thisObj);
			if (!(thisObj is FirebugConsole))
				throw new JavaScriptException(ErrorType.TypeError, "The method 'groupCollapsed' is not generic.");
			switch (args.Length)
			{
				case 0:
		...
		private static object __STUB__GroupEnd(ScriptEngine engine, object thisObj, object[] args)
		{
			thisObj = TypeConverter.ToObject(engine, thisObj);
			if (!(thisObj is FirebugConsole))
				throw new JavaScriptException(ErrorType.TypeError, "The method 'groupEnd' is not generic.");
		...
		private static object __STUB__Time(ScriptEngine engine, object thisObj, object[] args)
		{
			thisObj = TypeConverter.ToObject(engine, thisObj);
			if (!(thisObj is FirebugConsole))
				throw new JavaScriptException(ErrorType.TypeError, "The method 'time' is not generic.");
			switch (args.Length)
			{
				case 0:
		...
		private static object __STUB__TimeEnd(ScriptEngine engine, object thisObj, object[] args)
		{
			thisObj = TypeConverter.ToObject(engine, thisObj);
			if (!(thisObj is FirebugConsole))
				throw new JavaScriptException(ErrorType.TypeError, "The method 'timeEnd' is not generic.");
			switch (args.Length)
			{
				case 0:

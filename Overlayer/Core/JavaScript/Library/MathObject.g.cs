	...
	public partial class MathObject
	{
		private static List<PropertyNameAndValue> GetDeclarativeProperties(ScriptEngine engine)
		{
			return new List<PropertyNameAndValue>(47)
			{
				...
				new PropertyNameAndValue("abs", new ClrStubFunction(engine, "abs", 1, __STUB__Abs), PropertyAttributes.NonEnumerable),
				new PropertyNameAndValue("acos", new ClrStubFunction(engine, "acos", 1, __STUB__Acos), PropertyAttributes.NonEnumerable),
				new PropertyNameAndValue("asin", new ClrStubFunction(engine, "asin", 1, __STUB__Asin), PropertyAttributes.NonEnumerable),
				new PropertyNameAndValue("atan", new ClrStubFunction(engine, "atan", 1, __STUB__Atan), PropertyAttributes.NonEnumerable),
				new PropertyNameAndValue("atan2", new ClrStubFunction(engine, "atan2", 2, __STUB__Atan2), PropertyAttributes.NonEnumerable),
				new PropertyNameAndValue("ceil", new ClrStubFunction(engine, "ceil", 1, __STUB__Ceil), PropertyAttributes.NonEnumerable),
				new PropertyNameAndValue("cos", new ClrStubFunction(engine, "cos", 1, __STUB__Cos), PropertyAttributes.NonEnumerable),
				new PropertyNameAndValue("exp", new ClrStubFunction(engine, "exp", 1, __STUB__Exp), PropertyAttributes.NonEnumerable),
				new PropertyNameAndValue("floor", new ClrStubFunction(engine, "floor", 1, __STUB__Floor), PropertyAttributes.NonEnumerable),
				new PropertyNameAndValue("log", new ClrStubFunction(engine, "log", 1, __STUB__Log), PropertyAttributes.NonEnumerable),
				new PropertyNameAndValue("max", new ClrStubFunction(engine, "max", 2, __STUB__Max), PropertyAttributes.NonEnumerable),
				new PropertyNameAndValue("min", new ClrStubFunction(engine, "min", 2, __STUB__Min), PropertyAttributes.NonEnumerable),
				new PropertyNameAndValue("pow", new ClrStubFunction(engine, "pow", 2, __STUB__Pow), PropertyAttributes.NonEnumerable),
				new PropertyNameAndValue("random", new ClrStubFunction(engine, "random", 0, __STUB__Random), PropertyAttributes.NonEnumerable),
				new PropertyNameAndValue("round", new ClrStubFunction(engine, "round", 1, __STUB__Round), PropertyAttributes.NonEnumerable),
				new PropertyNameAndValue("sin", new ClrStubFunction(engine, "sin", 1, __STUB__Sin), PropertyAttributes.NonEnumerable),
				new PropertyNameAndValue("sqrt", new ClrStubFunction(engine, "sqrt", 1, __STUB__Sqrt), PropertyAttributes.NonEnumerable),
				new PropertyNameAndValue("tan", new ClrStubFunction(engine, "tan", 1, __STUB__Tan), PropertyAttributes.NonEnumerable),
				new PropertyNameAndValue("log10", new ClrStubFunction(engine, "log10", 1, __STUB__Log10), PropertyAttributes.NonEnumerable),
				new PropertyNameAndValue("log2", new ClrStubFunction(engine, "log2", 1, __STUB__Log2), PropertyAttributes.NonEnumerable),
				new PropertyNameAndValue("log1p", new ClrStubFunction(engine, "log1p", 1, __STUB__Log1p), PropertyAttributes.NonEnumerable),
				new PropertyNameAndValue("expm1", new ClrStubFunction(engine, "expm1", 1, __STUB__Expm1), PropertyAttributes.NonEnumerable),
				new PropertyNameAndValue("cosh", new ClrStubFunction(engine, "cosh", 1, __STUB__Cosh), PropertyAttributes.NonEnumerable),
				new PropertyNameAndValue("sinh", new ClrStubFunction(engine, "sinh", 1, __STUB__Sinh), PropertyAttributes.NonEnumerable),
				new PropertyNameAndValue("tanh", new ClrStubFunction(engine, "tanh", 1, __STUB__Tanh), PropertyAttributes.NonEnumerable),
				new PropertyNameAndValue("acosh", new ClrStubFunction(engine, "acosh", 1, __STUB__Acosh), PropertyAttributes.NonEnumerable),
				new PropertyNameAndValue("asinh", new ClrStubFunction(engine, "asinh", 1, __STUB__Asinh), PropertyAttributes.NonEnumerable),
				new PropertyNameAndValue("atanh", new ClrStubFunction(engine, "atanh", 1, __STUB__Atanh), PropertyAttributes.NonEnumerable),
				new PropertyNameAndValue("hypot", new ClrStubFunction(engine, "hypot", 2, __STUB__Hypot), PropertyAttributes.NonEnumerable),
				new PropertyNameAndValue("trunc", new ClrStubFunction(engine, "trunc", 1, __STUB__Trunc), PropertyAttributes.NonEnumerable),
				new PropertyNameAndValue("sign", new ClrStubFunction(engine, "sign", 1, __STUB__Sign), PropertyAttributes.NonEnumerable),
				new PropertyNameAndValue("imul", new ClrStubFunction(engine, "imul", 2, __STUB__IMul), PropertyAttributes.NonEnumerable),
				new PropertyNameAndValue("fround", new ClrStubFunction(engine, "fround", 1, __STUB__Fround), PropertyAttributes.NonEnumerable),
				new PropertyNameAndValue("clz32", new ClrStubFunction(engine, "clz32", 1, __STUB__Clz32), PropertyAttributes.NonEnumerable),
				new PropertyNameAndValue("cbrt", new ClrStubFunction(engine, "cbrt", 1, __STUB__Cbrt), PropertyAttributes.NonEnumerable),
			};
		}

...
using Binder = Overlayer.Core.JavaScript.Compiler.Binder;
...
namespace Overlayer.Core.JavaScript.Library
{
    ...
    public class ClrFunction : FunctionInstance
    {
        ...
        private class EmptyBinder : Binder
        {
            ...
            /// <returns> A delegate that does type conversion and calls the method represented by this
            /// object. </returns>
            protected override void GenerateStub(Overlayer.Core.JavaScript.Compiler.ILGenerator generator, int argumentCount)
            {
                // Emit undefined.

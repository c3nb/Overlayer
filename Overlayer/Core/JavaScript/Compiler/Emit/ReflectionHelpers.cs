...
using PropertyAttributes = Overlayer.Core.JavaScript.Library.PropertyAttributes;
...
namespace Overlayer.Core.JavaScript.Compiler
{
    ...
    /// Emit, all calls into Overlayer.Core.JavaScript.dll are cross-assembly and thus must be public).
    /// </summary>

...
namespace Neo.IronLua
{
	...
	public sealed class LuaThread : IAsyncResult, IDisposable
	{
		...
		object IAsyncResult.AsyncState => this;
		WaitHandle IAsyncResult.AsyncWaitHandle => evYield.WaitHandle;
		bool IAsyncResult.CompletedSynchronously => evYield == null;
		bool IAsyncResult.IsCompleted => evYield == null ? true : evYield.IsSet;

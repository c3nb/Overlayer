...
namespace JSEngine.Library
{
    ...
    public partial class ObjectInstance
    {
        ...
        protected virtual object GetPropertyValue(uint index, object thisValue)
        {
            ...
            if (result == null)
                result = GetArrayElementPropertyValue(index, thisValue as ObjectInstance);
            if (result == null)
                result = GetIndexerPropertyValue(index, thisValue as ObjectInstance);
            return result;
        }
        ...
        public virtual object GetPropertyValue(PropertyReference propertyReference)
        {
            ...
            else
            {
                ...
                return propertyValuePrototype ?? Undefined.Value;
            }
        }
        /// <summary>
        ...
        public virtual bool SetPropertyValue(uint index, object value, object thisValue, bool throwOnError)
        {
            ...
            if (!exists && !SetIndexerPropertyValue(index, value, this))
            {

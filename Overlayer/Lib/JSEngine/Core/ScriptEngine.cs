...
#pragma warning restore CS0618
            ...
            else if (value != Undefined.Value && value != Null.Value)
            {
                switch (Type.GetTypeCode(value.GetType()))
                {
                    ...
                    case TypeCode.Object:
                        ...
                        {
                            SetGlobalFunction(variableName, d);
                            return;
                        }
                        else if (value is System.Reflection.MethodInfo m)
                        {
                            SetGlobalFunction(variableName, m);
                            return;
                        }
        ...
        /// </summary>
        /// <param name="functionName"> The name of the global variable to set. </param>
        /// <param name="functionMethod"> The method that will implement the function. </param>
        public void SetGlobalFunction(string functionName, System.Reflection.MethodInfo functionMethod)
        {
            if (functionName == null)
                throw new ArgumentNullException(nameof(functionName));
            if (functionMethod == null)
                throw new ArgumentNullException(nameof(functionMethod));
            SetGlobalValue(functionName, new ClrFunction(this.Function.InstancePrototype, functionMethod, functionName));
        }

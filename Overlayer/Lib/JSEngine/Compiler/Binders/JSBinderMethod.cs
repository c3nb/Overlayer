...
namespace JSEngine.Compiler
{
    ...
    internal class JSBinderMethod : BinderMethod
    {
        ...
        static bool CheckFirstArgIsEngine(MethodBase method)
        {
            var p = method.GetParameters();
            if (p.Length < 1) return false;
            return p[0].ParameterType == typeof(ScriptEngine);
        }
        /// <summary>
        /// Creates a new FunctionBinderMethod instance.
        /// </summary>
        ...
        {
            this.Flags = flags;
            this.HasEngineParameter = (flags & JSFunctionFlags.HasEngineParameter) != 0 || CheckFirstArgIsEngine(Method);

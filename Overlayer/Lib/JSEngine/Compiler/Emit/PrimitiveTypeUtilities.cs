...
namespace JSEngine.Compiler
{
    ...
    internal static class PrimitiveTypeUtilities
    {
        ...
        public static bool ToPrimitiveType(Type type, out PrimitiveType pType)
        {
            pType = PrimitiveType.FUCK;
            if (type == typeof(object))
                pType = PrimitiveType.Any;
            if (type == typeof(Undefined))
                pType = PrimitiveType.Undefined;
            if (type == typeof(Null))

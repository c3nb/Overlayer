...
namespace Overlayer.Patches
{
    ...
    public static class StartProgUpdater
    {
        ...
        {
            if ((scnEditor.instance != null || __instance.controller.currentState == scrController.States.PlayerControl) && (__instance.controller.goShown || __instance.conductor.fastTakeoff))
            {
                ...
                if (__instance.controller.curCountdown < __instance.conductor.extraTicksCountdown.Count && num > __instance.conductor.extraTicksCountdown[__instance.controller.curCountdown].time)
                {
                    if (num < __instance.conductor.extraTicksCountdown[__instance.controller.curCountdown].time + 1.0)
                    {
                        ...
                        SetStartProg(scrController.instance);
                    }
            ...
            if (!__instance.controller.goShown && !__instance.conductor.fastTakeoff && (scrController.CheckStateIs("PlayerControl") || scrController.CheckStateIs("Countdown") || scrController.CheckStateIs("Checkpoint")))
            {

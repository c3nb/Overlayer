...
namespace Overlayer.Tags
{
    ...
    {
        public static LevelData ldAuto => scnGame.instance?.levelData ?? scnEditor.instance?.levelData;
        ...
        public static double EditorPitch(int digits = -1) => (ldAuto?.pitch / 100.0).Round(digits);
        ...
        public static string Title() => TitleRaw().BreakRichTag();
        ...
        [Tag("TitleRaw", Category = Category.Song)]
        public static string TitleRaw() => ldAuto?.song;
        [Tag("AuthorRaw", Category = Category.Song)]
        public static string AuthorRaw() => ldAuto?.author;
        [Tag("ArtistRaw", Category = Category.Song)]
        public static string ArtistRaw() => ldAuto?.artist;

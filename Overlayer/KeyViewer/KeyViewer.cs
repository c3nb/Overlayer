...
namespace Overlayer.KeyViewer
{
    ...
    internal class KeyViewer : MonoBehaviour
    {
        ...
        {
            if (keysObject) Destroy(keysObject);
        ...
        public void UpdateLayout()
        {
            ...
            foreach (KeyCode code in keyOutlineImages.Keys)
            {
                ...
                countText.resizeTextMaxSize = KEY_COUNT_FONT_SIZE;
        ...
        public void UpdateState(Dictionary<KeyCode, bool> state)
        {
            foreach (KeyCode code in keyOutlineImages.Keys)
            {
                if (state[code] == keyPrevStates[code]) continue;
        ...
        {
            return $"overlayer.key_viewer.{code}";
        }
